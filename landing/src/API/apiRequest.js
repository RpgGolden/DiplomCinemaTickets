...
export const getUserBonus = async () =>{
    try {
        const response = await api.get(GET_USER_BONUS_URL);
        return response;
    } catch (error) {
        return error;
    }
...
export const getPaymentMethods = async () => {
    try {
        const response = await api.get(GET_PAYMENT_METHODS_URL);
        return response;
    } catch (error) {
        return error;
    }
...
export const createPaymentMethods = async data => {
    try {
        const response = await api.post(CREATE_PAYMENT_METHODS_URL, data);
        return response;
    } catch (error) {
        return error;
    }
